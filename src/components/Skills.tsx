...
import {  CPPIcon, CSSIcon, ExpressIcon, GithubIcon, GitIcon,  HTMLIcon, JavaSciptIcon, MongoDBIcon, NodeJsIcon, PostgresIcon, PostmanIcon, PrismaIcon, ReactIcon, ReduxIcon, TailwindIcon, TypeScriptIcon, DrizzleIcon, JWTIcon, MySQLIcon, ShadCNIcon,  VsCodeIcon, Auth0Icon} from "./ui/icons"
...
const skills: Skill[] = [
    ...
    {name: "Dart",category:"Programming Languages", icon: <CPPIcon/>},
    ...
    { name: "Auth0", category: "Backend", icon: <Auth0Icon /> },
    ...
    { name: "Mongoose", category: "Databases", icon: <DrizzleIcon /> },
