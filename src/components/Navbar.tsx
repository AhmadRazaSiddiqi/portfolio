...
export function Navbar() {
    ...
    const handleDownloadResume = () => {
        ...
        const resumeUrl = "https://drive.google.com/file/d/1eK690mYJwcyTGGXqRBZNnTQFEjAxzY5F"
    ...
    return (
        <main className="fixed w-full z-20">
            <Nav>
                ...
                <NavBody>
                    {/* <NavbarLogo /> */}
                    <span className="font-bold   text-2xl  font-sans"> &lt;AR/&gt;</span>
                ...
                <MobileNav>
                    <MobileNavHeader>
                        <span className="font-bold text-md font-sans">&lt;AR/&gt;</span>
                        <MobileNavToggle
